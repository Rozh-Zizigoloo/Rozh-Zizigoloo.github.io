...
Animate.prototype.options = {
    ...
    updateClosest: false, // Update closest points each loop
...
/**
 * Point Constructor
 * @param    position   {Object}     set of x and y coords
...
/**
 * Draws lines to the closest points
 */
...
/**
 * Tween loop to move each point around its origin
 */
...
// Custom loader and transition to main content
document.addEventListener('DOMContentLoaded', function () {
    setTimeout(function () {
        document.getElementById('animated-background').style.display = 'none';
        document.getElementById('main-content').style.display = 'block';
    }, 5000); // Adjust this timeout to control the loader display duration
});
